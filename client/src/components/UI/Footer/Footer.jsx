...
export function Footer() {
  ...
  return (
    <footer
      className={`background-2 footer rounded-top-4 pt-2 mt-4`}
    >
      <Container fluid>
        ...
        <Row
          className={`background-1 rounded-top-4 pt-4 ps-4 d-flex justify-content-center align-items-center ${
            classes.lower_footer
          }`}
        >
          <p className="text-white text-center fs-4">
            © 2025, HealthCheck, Inc.
          </p>
        </Row>
      </Container>
    </footer>
